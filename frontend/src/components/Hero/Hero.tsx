  ...
  return (
    <section className="p-6">
      <div className="grid grid-cols-12 auto-rows-[120px] gap-4">
        ...
        <div className="col-span-6 md:col-span-8 row-span-2 rounded-2xl bg-neutral-700 p-4">
          Trending
        </div>
      </div>
    </section>
