  ...
  return (
    <section className="p-6">
      <div className="grid grid-cols-12 auto-rows-[150px] gap-4">
        <HeroCarousel className="col-span-12 lg:col-span-8 row-span-3" />

        <HeroDetails className="col-span-12 lg:col-span-4 row-span-3" />

        <HeroEpisodes className="col-span-12 lg:col-span-8 row-span-2" />

        <HeroCast className="col-span-12 lg:col-span-4 row-span-2 " />
